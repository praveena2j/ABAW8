...
if __name__ == '__main__':
    ...
    parser.add_argument('-save_path', default='/misc/scratch11/8th-ABAW_Competition/save', type=str,
                        help='The path to save the trained models ')  # /scratch/users/ntu/su012/trained_model
    parser.add_argument('-python_package_path', default='/misc/scratch11/RCMA_new_AV_MGRCA_ABAW8', type=str,
